...
const Hero = () => (
  <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
    ...
    <div className="container mx-auto px-4 text-center relative z-10">
      <p className="mb-10">
        <Salad strokeWidth={1.2} className="w-40 h-40 inline-block" />
      </p>
      <h2 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
        <span className="font-normal">Powering</span>{" "}
        <span className="text-emerald-400">Nutrition</span> Intelligence
      </h2>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center">
        <div className="md:w-1/3 mb-8 md:mb-0">
          <img
            ...
            alt="Lucas Czekaj"
            className="rounded-full w-96 h-96 object-cover mx-auto border-0 border-emerald-400/20"
          />
        </div>
